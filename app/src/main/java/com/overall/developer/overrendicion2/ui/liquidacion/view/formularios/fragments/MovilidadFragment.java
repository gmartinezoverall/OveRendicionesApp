...
public class MovilidadFragment extends Fragment {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnGuardar:
                ...
                //26-03 por Gustavo M. para validar cada campo vacío
                if(ValideWidgets()){
    ...
    private boolean ValideWidgets() {
        ...
        if (etxMotivo.getText().toString().isEmpty()){
            ...
            return false;
        }else if(txvFechaInicio.getText().toString().isEmpty()){
            Toast.makeText(mView.getContext(), "Falta la Fecha", Toast.LENGTH_SHORT).show();
            return false;
        }else if(btnMasivo.isChecked() && txvFechaFin.getText().toString().equals("-")) {
            Toast.makeText(mView.getContext(), "Falta Fecha Fin", Toast.LENGTH_SHORT).show();
            return false;
        }else{
            return true;
        }
