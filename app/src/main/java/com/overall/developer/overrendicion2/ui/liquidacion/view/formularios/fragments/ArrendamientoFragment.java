...
/*        etxNSerie.setOnFocusChangeListener((v, hasFocus) ->
    ...
    private void setAllDefaultValues() {
        ...
        //22-04 por Gustavo M. para validar si el campo NumeroDoc contiene el caracter '-'
        if(rendicionEntity.getNumeroDoc().indexOf('-')==-1){
            etxNDocumento.setText(rendicionEntity.getNumeroDoc());
        }else{
    ...
    //08-04 por Gustavo M. para validar cada campo del formulario
