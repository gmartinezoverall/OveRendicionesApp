...
public class CartaPorteAereoFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_carta_porte_aereo, container, false);
...
/*        etxNSerie.setOnFocusChangeListener((v, hasFocus) ->
    ...
    private void setAllDefaultValues() {
        ...
        String[] strings = rendicionEntity.getNumeroDoc().split("\\-"); //29-03 por Gustavo M. se cambió '|' por '-' porque lo registra con '-'
        ...
        switch (view.getId()) {
            case R.id.btnGuardar:
                ...
                if (ValideWidgets()) {
                    ...
                    if(etxOtrosGastos.getText().toString().isEmpty())etxOtrosGastos.setText("0"); //29-03 por Gustavo M. para asignar 0 cuando este campo esté vacío
