...
import com.overall.developer.overrendicion2.ui.liquidacion.presenter.Pendiente.PendientePresenter;
import com.overall.developer.overrendicion2.ui.liquidacion.presenter.Pendiente.PendientePresenterImpl;
import com.overall.developer.overrendicion2.ui.liquidacion.view.pendiente.adapter.PendienteAdapter;
...
import com.overall.developer.overrendicion2.utils.toolbarRippleEffect.RippleEffect;
...
/*        Log.i("NDa","NDa");
    ...
    protected void onStop() {
        super.onStop();
        if (mDialogPhono != null) { mDialogPhono.dismiss(); mDialogPhono = null; } //21-03 por Gustavo M.
        if (mDialog != null) { mDialog.dismiss(); mDialog = null; } //21-03 por Gustavo M.
    ...
    void timerInterval()
    {
        Observable.timer(3000, TimeUnit.MILLISECONDS)
                .subscribe(timer ->
                {
                    ...
                    if(mDialog != null){mDialog.dismiss();} //21-03 por Gustavo M. para validar que no sea nulo
                });
    }
