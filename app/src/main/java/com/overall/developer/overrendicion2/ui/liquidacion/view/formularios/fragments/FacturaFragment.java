...
*/
    ...
    private void sumaTotal() {
        ...
        if (etxValorVenta != null) {
            ...
            validarMonto(); //26-03 por Gustavo M. para validar monto menor a 700 soles
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnGuardar:
                ...
                if (ValideWidgets()) {
                    if (validarMonto()) { //26/03 por Gustavo M. para validar monto menor a 700 soles
    ...
    //25-03 por Gustavo M. para validar cada campo y se quitó el campo etxOtrosGastos
