...
/*        etxNSerie.setOnFocusChangeListener((v, hasFocus) ->
    ...
    private void setAllDefaultValues() {
        ...
        //29-03 por Gustavo M. para que valide la ruta de la foto
    ...
    private boolean ValideWidgets() {
        ...
        if(txvFechaDocumento.getText().toString().isEmpty()){
            ...
            return false;
        }else if(etxMontoAfectado.getText().toString().isEmpty()){
            Toast.makeText(mView.getContext(), "Falta Monto afectado", Toast.LENGTH_SHORT).show();
            return false;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnGuardar:
                ...
                if (ValideWidgets()) {
                    if(etxMontoNoAfectado.getText().toString().isEmpty())etxMontoNoAfectado.setText("0");
                    ((FormularioActivity) getContext()).saveAndSendData(((FormularioActivity) getContext()).getSelectTypoDoc(), new OtrosDocumentosEntity(String.valueOf(((FormularioActivity) getContext()).getSelectTypoDoc()),
                            String.valueOf(txvFechaDocumento.getText()), String.valueOf(etxNSerie.getText()) + "-" + String.valueOf(etxNDocumento.getText()), String.valueOf(etxMontoAfectado.getText()), String.valueOf(etxMontoNoAfectado.getText()), String.valueOf(rtgId),
