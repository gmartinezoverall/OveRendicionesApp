...
public class ColorDialog extends Dialog implements View.OnClickListener {
    ...
    private GifImageView mContentIv;
    ...
    private CharSequence mTitleText, mContentText, mContentHit, mPositiveText, mNegativeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentIv = (GifImageView) contentView.findViewById(R.id.ivContent);
    ...
    public ColorDialog setContentText(CharSequence text, CharSequence hit) {
        mContentText = text;
        mContentHit = hit;
    ...
    public ColorDialog setContentText(int textId, int textHit) {
        return setContentText(getContext().getText(textId), getContext().getText(textHit));
    }

    public ColorDialog setContentImage(GifDrawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public interface OnPositiveListener {
        String onClick(ColorDialog dialog);
    }
