...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    public static final int BUTTON_CLEAR = 4;
    ...
    private EditText searchEdit, txvTipoBuscar;
    ...
    private void init(AttributeSet attrs) {
        ...
        txvTipoBuscar = findViewById(R.id.txvTipoBuscar);
    ...
    public void setTxvTipoBuscar(String tipoBuscar)
    {
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
        if (listenerExists())
            onSearchActionListener.onSearchConfirmed(String.valueOf(searchEdit.getText()));
        if (suggestionsVisible)
            hideSuggestionsList();
        if (adapter instanceof DefaultSuggestionsAdapter)
